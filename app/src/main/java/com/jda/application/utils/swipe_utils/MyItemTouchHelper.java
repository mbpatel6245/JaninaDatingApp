...
package com.jda.application.utils.swipe_utils;
...
private MotionEvent downEvent;
    ...
    private final OnItemTouchListener mOnItemTouchListener = new OnItemTouchListener() {
        ...
        public boolean onInterceptTouchEvent(@NonNull RecyclerView recyclerView,
            ...
            if (action == MotionEvent.ACTION_DOWN) {
                downEvent = event;
                Log.e("action", "MotionEvent.ACTION_DOWN");
                ...
                Log.e("action", "MotionEvent.ACTION_CANCEL || action == MotionEvent.ACTION_UP");

                mActivePointerId = ACTIVE_POINTER_ID_NONE;
                select(null, ACTION_STATE_IDLE);

                if(mInitialTouchX == event.getX() && mInitialTouchY == event.getY()){
                    View childView = recyclerView.findChildViewUnder(event.getX(), event.getY());

                    mCallback.onClicked(recyclerView.getChildAdapterPosition(childView));
                }

            } else if (mActivePointerId != ACTIVE_POINTER_ID_NONE) {
                Log.e("action", "ACTIVE_POINTER_ID_NONE");
        ...
        public void onTouchEvent(@NonNull RecyclerView recyclerView, @NonNull MotionEvent event) {
            ...
            switch (action) {
                ...
                case MotionEvent.ACTION_CANCEL:
                    Log.e("onTouchEvent", "MotionEvent.ACTION_CANCEL");
                ...
                case MotionEvent.ACTION_POINTER_UP: {
                    Log.e("onTouchEvent", "MotionEvent.ACTION_POINTER_UP");
     ...
     * {@link MyItemTouchHelper}.
     */
    public interface ViewDropHandler {

        /**
         * Called by the {@link MyItemTouchHelper} after a View is dropped over another View.
         * <p>
    ...
    public abstract static class Callback {
        ...
        public static ItemTouchUIUtil getDefaultUIUtil() {
            return MyItemTouchUIUtilImpl.INSTANCE;
        }
         ...
         *                    it is cleared.
         * @param actionState One of {@link MyItemTouchHelper#ACTION_STATE_IDLE},
         *                    {@link MyItemTouchHelper#ACTION_STATE_SWIPE} or
         *                    {@link MyItemTouchHelper#ACTION_STATE_DRAG}.
         * @see #clearView(RecyclerView, ViewHolder)
         */
        public void onSelectedChanged(@Nullable ViewHolder viewHolder, int actionState) {
            if (viewHolder != null) {
                MyItemTouchUIUtilImpl.INSTANCE.onSelected(viewHolder.itemView);
            }
        }
        ...
        public void clearView(@NonNull RecyclerView recyclerView, @NonNull ViewHolder viewHolder) {
            MyItemTouchUIUtilImpl.INSTANCE.clearView(viewHolder.itemView);
        }
        ...
        public void onChildDraw(@NonNull Canvas c, @NonNull RecyclerView recyclerView,
            ...
            MyItemTouchUIUtilImpl.INSTANCE.onDraw(c, recyclerView, viewHolder.itemView, dX, dY,
                    actionState, isCurrentlyActive);
        }
        ...
        public void onChildDrawOver(@NonNull Canvas c, @NonNull RecyclerView recyclerView,
                                    ViewHolder viewHolder,
                                    float dX, float dY, int actionState, boolean isCurrentlyActive) {
            MyItemTouchUIUtilImpl.INSTANCE.onDrawOver(c, recyclerView, viewHolder.itemView, dX, dY,
                    actionState, isCurrentlyActive);
        }
